                    ...
                    <Grid container spacing={2} className={classes.postCenter}>
                        <Grid item>
                            ...
                            <p className={classes.p}>
                                I have always loved music.  I became an editor for Genius in the spring of 2016.&nbsp;<a href="https://www.genius.com/unannotatedunmastered" target="_blank" rel="noopener noreferrer">My profile</a>&nbsp;contains the majority of my work for the site.  I used to be addicted to this site, but I haven't been as active in recent years.
                            </p>
                        </Grid>
                    </Grid>
                </Grid>
